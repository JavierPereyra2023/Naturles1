# Add sidebar TOC + scroll-spy to candidate pages — v3 production version
...
$candidates = if ($Only.Count -gt 0) { $Only } else { $allCandidates }
...
foreach ($rel in $candidates) {
  ...
  # 2) Insertar id="slug" en cada apertura de sección
